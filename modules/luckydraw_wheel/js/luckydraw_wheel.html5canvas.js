      ...
      var wheel = {
        ...
        spin : function() {
          ...
          if (wheel.timerHandle == 0) {
            var state = confirm("It will take you 50 points");
            if (state == true) {
        ...
        onTimerTick : function() {
          ...
          if (finished) {
            ...
            // alert(wheel.entities[i]);
            var items = JSON.parse(Drupal.settings.lucky_draw_items);
            var this_item = items[wheel.entities[i]];
            alert(this_item.field_awd_text);
